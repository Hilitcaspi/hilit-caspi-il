...
- [x] להריץ בדיקות ממוקדות, pnpm test, pnpm check, pnpm build ו־git diff --check: 454 בדיקות עברו, בדיקה אחת דולגה כמתוכנן
- [ ] לאמת את מסלול המדידה מקומית ובייצור ללא ביצוע חיוב אמיתי
- [ ] לבצע לאחר אימות המדידה את איפוס התקציבים והקמפיינים שאושר, בלי למחוק היסטוריה
- [ ] לאמת שהקמפיינים הפעילים והתקציבים בפועל תואמים לתוכנית 72 השעות
- [ ] לתעד, לשמור checkpoint, לפרסם, לסנכרן ל־GitHub ולעקוב אחר אות Purchase מול Grow

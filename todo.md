...
- [ ] לאבחן מדוע Make החזיר HTTP 200 אך הודעות הניסיון לא הגיעו ל־WhatsApp
- [ ] להתאים את ה־payload למבנה השדות שהתרחיש הפעיל דורש, כולל מספר יעד ומספר שולח
- [ ] להוסיף בדיקה שמבדילה בין קבלת webhook לבין אישור מסירה אמיתי
- [ ] לשלוח מחדש הודעת ניסיון לשחר ולהילית ולאמת קבלה בפועל
- [ ] לפרסם את התיקון ולסנכרן את ה־checkpoint ל־GitHub

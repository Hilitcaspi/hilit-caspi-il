...
- [ ] לאמת מחדש את 60 טיוטות סקר שביעות הרצון לפי מגדר, גיל, אזור ושלב
- [ ] לאשר לשליחה רק את גל הסקר המאושר ולהשאיר טיוטות אחרות ללא שינוי
- [ ] לשלוח את 60 סקרי שביעות הרצון באצווה מבוקרת עם קישור הסרה אישי
- [ ] לאמת מצרפית מסירה, כשלים, כפילויות ואפס הרשאות פרסום אוטומטיות

...
- [ ] לפרסם את מערכת ההמלצות במצב כבוי ולסנכרן ל־GitHub
- [ ] להפעיל את האוטומציה לפניות חוויה חדשות לאחר הפרסום
- [ ] לשלוח את גל 244 בקשות החוויה ההיסטוריות שאושר, ללא 60 סקרי שביעות הרצון
- [ ] להכין פילוח סקר לפי מגדר, אזור, גיל, ותק ושלב בתהליך ולהציג את השאלות לפני שליחה
- [ ] להשאיר את 60 טיוטות הסקר ללא שליחה עד אישור נפרד

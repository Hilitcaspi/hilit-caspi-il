...
- [ ] לאתר בלוגי הייצור את דיווח `profile_save` המדויק מהצילום בשעה 11:20 ואת קוד השגיאה מהשרת
...
- [x] לבדוק אם שמירת הפרופיל נכשלת עקב payload, שדה מסוים, race בין DNA לשמירה, timeout או כפילות: השמירה ו־createProcess הצליחו; הכשל היה race שבו Grow חשף runtime חלקי לפני `renderPaymentOptions`, וניסיון שני לאחר השלמת הטעינה פתח את חלון התשלום
...
- [x] להריץ בדיקות מלאות, TypeScript, build, diff וסריקת פרטיות לפני פרסום: 99 קובצי בדיקה עברו, אחד דולג כמתוכנן; 444 בדיקות עברו ואחת דולגה

...
- [ ] לאמת בדומיין החי שהקישור מחזיר אותה לשלב הנכון עם הנתונים שכבר מילאה; בבדיקה המקומית Chromium הציג ישירות את מסך התשלום על 299 ₪ ללא טופס אישי וללא חיוב
- [ ] לנקות קובצי ביקורת זמניים ולמסור קישור אישי ישיר להעתקה

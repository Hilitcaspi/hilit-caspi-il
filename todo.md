...
- [ ] לאמת את קישור התשלום וההסרות בכל 35 ההזמנות
- [ ] לשלוח מייל רק ל־35 המאושרים ולתעד מסירה אצל Brevo
...
- [ ] לשלוח מייל השלמת תשלום רק למי שאומת שלא חויב ולא פעיל, בהתאם לאישור המשתמשת

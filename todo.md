...
- [ ] לאשר את שלושת הקהלים למסירה במנות מבוקרות ולשמור idempotency
- [ ] לשלוח את 349 בקשות ההמלצה דרך ערוץ המייל הקיים בלבד
- [ ] לאמת את מספר ההצלחות, הכשלים וההחרגות ללא חשיפת פרטי נמענים
- [ ] לוודא שלא נוצרו כפילויות ושלא נשלחו SMS או WhatsApp
- [ ] לתזמן עדכון להילית בשעה 23:45 לפי שעון ישראל עם פתיחות ותגובות בפועל
- [ ] לתעד בעדכון סוף היום את בסיס המדידה ואת מגבלות מעקב הפתיחות

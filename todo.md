...
- [x] להריץ pnpm test, pnpm check, pnpm build ו־git diff --check
- [ ] לפרסם checkpoint ולסנכרן את התיקון ל־GitHub
- [ ] לשלוח לסיגל קישור אישי אחד ל־Boost לאחר הפרסום בלבד
- [ ] לאמת שהמייל התקבל אצל ספק המשלוח ולא לטעון שנפתח או נקרא

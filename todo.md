...
- [ ] להגדיר את חלון אתמול ואת חלון שבעת הימים האחרונים לפי שעון ישראל
- [ ] לאסוף את כל ההתאמות הייחודיות שנשלחו אתמול, כאשר שני אנשים נחשבים התאמה אחת
- [ ] לוודא שלכל התאמה מאתמול קיימים שני מיילים וששניהם התקבלו אצל ספק הדיוור
- [ ] לוודא שכל התאמה מאתמול מופיעה היום בטאב המעקב המתאים ב־CRM
- [ ] לזהות ולתקן התאמות שנשלחו אך נעלמו מהמעקב או נשארו בסטטוס שגוי
- [ ] לחשב בשבעת הימים האחרונים כמה התאמות נשלחו, נמסרו, הצליחו, ממתינות ושוחררו
- [ ] לדווח רק ספירות מצרפיות בלי לחשוף שמות, אימיילים או מזהי התאמה
...
- [ ] לפרסם ולסנכרן ל־GitHub את התיקון לפני אימות בייצור
- [ ] לאמת באתר החי יצירת Hosted Payment של Grow בשני המסלולים ללא הזנת כרטיס וללא חיוב
- [ ] לאמת באתר החי שהטוקן החינמי מופיע ועובד בלי להגיע לתשלום

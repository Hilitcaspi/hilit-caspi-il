...
- [x] להריץ pnpm test, pnpm check, pnpm build ו־git diff --check
- [ ] לפרסם checkpoint ולסנכרן GitHub לפני השלמת המייל החסר
- [ ] לשלוח להילית רק את מייל הקורס והמדריך החסר לאחר התיקון
- [ ] לאמת מסירה אצל Brevo בלי לטעון שהמייל נפתח או נקרא

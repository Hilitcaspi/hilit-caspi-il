...
- [ ] לאתר את מסמך היעדים והתקציבים המאושר ולמפות ממנו כל מוצר, מחיר, יעד כמותי, יעד הכנסה ותקציב
- [ ] לאמת שמחירי המוצרים והיעדים במסמך תואמים לקוד, לעמודי התשלום ולנתוני ספטמבר הפעילים
- [ ] לבנות חלוקה יומית דינמית לפי ימי השבוע, סופי שבוע, חגי ישראל וימים חזקים, בלי לשנות את היעד החודשי הכולל
- [ ] להגדיר לכל מוצר יעד יומי בכמות, הכנסה, תקציב, CPA יעד, CTA, ROAS והתקדמות שבועית וחודשית
- [ ] להרחיב את הגדרות הדוח לשני נמענים מאושרים בלי לחשוף את המספרים בממשק או בלוגים
- [ ] לפצל את דוח החצות לשלוש הודעות: יעדים ומכירות, תקציבים וקמפיינים, ומדדי המאגר
- [ ] לכלול בהודעת היעדים מכירות בפועל מול יעד לפי מוצר, מחיר, הכנסה, CPA, ROAS, לידים והתקדמות שבועית
- [ ] לכלול בהודעת הקמפיינים תקציב מתוכנן ובפועל, הוצאה לפי קמפיין ומוצר, CPA, ROAS, סטייה ותמרורי אזהרה
- [ ] לכלול בהודעת המאגר נרשמים חדשים מול יעד, התאמות שנשלחו, התאמות שהצליחו, חוסרי פרטים, מעל 14 יום ללא התאמה, לידים חדשים ו־Boost מול יעד
- [ ] לשמור מקור, טריות ומצב חסר לכל מדד ולא להציג אפס כאשר נתון אינו זמין
- [ ] לעדכן את מסך הניהול כך שיציג תצוגה מקדימה של שלוש ההודעות ומצב שני הנמענים
- [ ] להוסיף בדיקות לחישובי חלוקה יומית, חגים, סופי שבוע, שני נמענים, שלוש הודעות, כשל חלקי ו־idempotency
- [ ] להריץ dry-run עם נתוני אמת ללא שליחת SMS ולהציג להילית את שלוש ההודעות, היעדים והתקציבים לאישור סופי
- [ ] לאחר אישור סופי: לבצע שליחת ניסיון מבוקרת לשני הנמענים ולאמת תגובת ספק
- [ ] לפרסם, לסנכרן GitHub וליצור או להפעיל את תזמון חצות לפי שעון ישראל עם הגנת DST וכפילויות
- [ ] לאמת את הריצה הראשונה ולתעד מסירה לכל נמען ולכל אחת משלוש ההודעות
...
- [ ] לפרסם את הרחבת הדוח ולסנכרן GitHub
- [ ] ליצור או להפעיל את תזמון החצות העתידי עם הגנת שעון ישראל, DST ו־idempotency
- [ ] לאמת שהריצה העתידית תפיק שלוש הודעות לכל נמען פעם אחת בלבד לכל יום

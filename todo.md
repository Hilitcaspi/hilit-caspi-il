...
- [ ] לפרסם את התיקון ולסנכרן אותו ל־GitHub; checkpoint `5019995a` נשמר ונדחף, אך שירות Cloud Build החזיר שגיאת זמינות זמנית ונדרש ניסיון פרסום חוזר
- [ ] לאמת באתר החי שהשחרור עובד מקצה לקצה בלי למחוק היסטוריה או לשלוח הודעה ללקוחות

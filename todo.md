...
- [ ] לעצור פעולות הסרה נוספות ולהשאיר את כל היסטוריית ההתאמות הקיימת ללא מחיקה
- [ ] למפות את כל השדות והסטטוסים ששונו בפעולת ההסרה ואת ערכי השחזור הזמינים
- [ ] לשחזר את הפרופיל למאגר הפעיל בלי להפעיל מחדש שיווק או תורי מייל
- [x] להוסיף למנוע ההתאמות הרגיל סינון consentMatchmaking כדי שפרופיל פעיל וחסום לא יקבל התאמות אוטומטיות
- [ ] לשחזר את תשע ההתאמות שהיו פתוחות לפני ההסרה ולשמור את שתי הרשומות ההיסטוריות האחרות
- [ ] לשחזר את חברות Boost ואת שתי בקשות ה־Boost למצבן הקודם, בלי לשלוח הודעות
- [ ] לשחזר קישורי גישה או תמונה שנוטרלו רק אם ניתן לאתר את הערכים המקוריים בבטחה
- [ ] לאמת שהפרופיל וכל 11 ההתאמות מוצגים במערכת ושאין מיילים pending או processing
- [ ] למסור להילית פירוט מדויק של מה שוחזר ומה נשאר חסום בזמן הבדיקה

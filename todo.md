...
- [ ] לאמת הרצת Heartbeat חיה ללא כשל ולסנכרן את התיקון ל־GitHub
...
- [ ] לחבר בעתיד את רכיב סיפורי ההצלחה רק למשובי התאמה עם `consentConfirmed`, `publicityScope` ואימות צוות מתאים
...
- [ ] להוסיף דוחות יומיים, דוח מחצית ודוח סוף חודש מול יעדי המוצר והתקציב

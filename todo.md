...
- [ ] לבצע preflight סופי של 30 נשים, 30 גברים ו־3 מקרי השלמה מורשים
- [ ] לשלוח 60 מיילי השקה ו־60 הודעות SMS אישיות ללא כפילויות
- [ ] לשלוח ל־3 מקרי ההשלמה המורשים מייל ו־SMS, ללא פנייה ל־2 מוסרי הדיוור
- [ ] לאמת מצרפית קבלה אצל ספקי הדיוור וה־SMS ואפס הפעלות מנוי לפני תשלום

...
- [ ] לקבל מ־Grow pageCode ייעודי ל־Plus עם מספר החיובים, מדיניות ביטול ו־webhook לכשלי חיוב לפני פתיחת התשלום
...
- [ ] לתקן את פריסת הייצור כך ש־`/september` ייכלל בחבילת האתר החיה ולא יחזיר 404

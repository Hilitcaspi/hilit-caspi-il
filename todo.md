...
- [ ] להוסיף מודל נתונים מלא למשפך הצלחות: נשלח, נפתח, אושר, פרטים נחשפו, דייט נקבע, דייט התקיים, ממשיכים, זוגיות
- [ ] להוסיף מנגנון הסכמה מפורשת לפרסום תוצאה, ציטוט, שם ותמונה ללא יצירת עדויות מלאכותיות
- [ ] לבנות ממשק CRM לעדכון תוצאות, תיעוד משוב ואישור סיפור הצלחה לפרסום
- [ ] לבנות דשבורד תוצאות לפי קוהורט 30/60/90 יום, מקור שיווק, מוצר ומגזר
- [ ] לבנות מסע אוטומטי ל־90 יום לאחר רכישה עם הודעות לפי התנהגות ותוצאה
- [ ] לבנות מנוע אפסייל לפגישה, ליווי וקבוצה על בסיס מצב הלקוח ולא דיוור כללי
- [ ] לבנות דוח P&L חודשי עם הכנסות בפועל, הוצאות פרסום, סליקה, החזרים, שכר, ספקים, תוכנות ומסים
- [ ] לבנות פיילוט Plus כולל זכאות, הטבות, רשימת המתנה, מעקב המרה ומדדי שימור
- [ ] לבנות תשתית משימות והרשאות לצוות עבור התאמות, מעקב, שיחות ומשוב
- [ ] לבנות תשתית לניהול שותפים ואירועים עם שיוך לידים והכנסות
- [ ] לנסח מסרים אמינים על כמות ואיכות התאמות שמסבירים את ההמתנה בלי להבטיח התאמות שאינן קיימות
- [ ] לכתוב בדיקות Vitest, לבדוק מובייל ודסקטופ, ולבצע השקה מבוקרת עם מדדי הצלחה

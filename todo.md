...
- [ ] להכין כמות נמענים ונוסח הודעת שחזור עם LOVE10 לאישור, ללא שליחה אוטומטית
...
- [ ] לפרסם, לסנכרן ל־GitHub ולאמת במסלול חי שהקוד החינמי מופיע רק באזור התשלום
- [ ] לנקות את כל פרופילי, לידי וסשני ה־QA שנוצרו בבדיקות checkout

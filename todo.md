...
- [ ] לדווח להילית היכן מופיע כל כפתור וכמה סקרים נמסרו בפועל
...
- [ ] לפרסם את תיקוני המדידה ומסר המשוב המאושרים ולסנכרן GitHub
- [ ] לצמצם את ניסוי דפי היעד לתקציב ומשך שמתאימים לפיילוט קטן
- [ ] להגדיר בבירור אם יעד הניסוי הוא Purchase או Lead ולמה
- [ ] להפריד בין קהל קר, קהל חם וריטרגטינג בלי לערבב אוכלוסיות
- [ ] לשנות בכל תא רק את דף היעד ולשמור קריאייטיב, טקסט, קהל ותקציב זהים
- [ ] להגדיר מגבלת תקציב, משך, מדד הצלחה וכלל עצירה לפיילוט הקטן
- [ ] לנסח מודעת חג חדשה: ה־DNA היה נקודת הפתיחה ועכשיו עוברים לעבודה אמיתית ולמציאת אהבה
- [ ] ליצור גרסת פיד 1:1 למודעת ההמשך אחרי DNA
- [ ] ליצור גרסת סטורי 9:16 למודעת ההמשך אחרי DNA
- [ ] לשמור על מחירי 499, 249 ו־497 ₪, שווי 1,245 ₪ ומחיר חג 399 ₪ אם המחירים מוצגים
- [ ] לבדוק את העברית, הזהות, הקריאות ואזורי הבטיחות בשתי המודעות
- [ ] להכין טקסט ראשי, כותרת, תיאור, CTA, קהל ומטרת קמפיין למודעת ה־DNA
- [ ] למסור את תוכנית הניסוי והמודעות בלי להפעיל קמפיין

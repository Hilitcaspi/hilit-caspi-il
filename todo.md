...
- [ ] לשחזר את אותו מסלול גם בתצוגת מובייל ובדפדפן WebKit/Safari ככל שניתן
...
- [ ] לפרסם ולסנכרן ל־GitHub את תיקון החירום
- [ ] לאמת בדסקטופ ובמובייל מעבר מטופס מלא ל־Hosted Payment של Grow בלי כרטיס ובלי חיוב
- [ ] לאמת שכשל יזום מדווח להתראה ושלא נשמרים פרטים אישיים בלוג
- [ ] לדווח על שורש הכשל האמיתי ועל חלון הזמן המעודכן בלי להסתמך על הנחות

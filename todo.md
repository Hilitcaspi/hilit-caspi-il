...
- [x] לתקן את המסלול כך שטוקן גישה חינמית יזוהה גם בשדה שבו המשתמש הזין אותו, ולהציג את שדה הגישה לפני התשלום
- [x] להוסיף בדיקות רגרסיה לטוקן מלא ארוך, הדבקה, רישיות, רווחים והסתרת התשלום לאחר אימות

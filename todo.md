...
- [ ] לבצע התאמת ניסיון מאושרת לשני המספרים דרך WhatsApp ללא SMS
- [ ] לפרסם את השינוי ולסנכרן את ה־checkpoint ל־GitHub
...
- [ ] לבצע התאמות ושליחות ניסיון מאושרות לשחר ולהילית, לפרסם ולסנכרן ל־GitHub

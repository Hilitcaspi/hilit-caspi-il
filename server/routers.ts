        ...
        const suggestions = candidates
          .map(c => {
            ...
            return {
              ...
              religiosity: c.religiosity,
              shomerShabbat: c.shomerShabbat,
              about: c.about,
              partnerDescription: c.partnerDescription,
              occupation: c.occupation,
              smokingStatus: c.smokingStatus,
              hasPets: c.hasPets,
              petType: c.petType,
      ...
      .query(async ({ ctx, input }) => {
        ...
        const allOpponents = allOpponentIds.length > 0
          ? await db.select({
              ...
              maritalStatus: singles.maritalStatus, hasKids: singles.hasKids,
              numKids: singles.numKids, wantsKids: singles.wantsKids,
              smokingStatus: singles.smokingStatus, hasPets: singles.hasPets,
              shomerShabbat: singles.shomerShabbat, about: singles.about,
              partnerDescription: singles.partnerDescription, email: singles.email,
              minAgePreference: singles.minAgePreference,
              maxAgePreference: singles.maxAgePreference,
        ...
        return top9.map(m => {
          ...
          return {
            ...
            opponent: opponent ? {
              ...
              maritalStatus: opponent.maritalStatus,
              hasKids: opponent.hasKids,
              numKids: opponent.numKids,
              wantsKids: opponent.wantsKids,
              smokingStatus: opponent.smokingStatus,
              hasPets: opponent.hasPets,
              shomerShabbat: opponent.shomerShabbat,
              about: opponent.about,
              partnerDescription: opponent.partnerDescription,
      ...
      .query(async ({ ctx, input }) => {
        ...
        const [allSingles, allMatches, leadAttribution, purchaseHistory] = await Promise.all([
          ...
          db.select({
            ...
            ownerApprovedAt: matches.ownerApprovedAt,
            approvalTokenA: matches.approvalTokenA,
            approvalTokenB: matches.approvalTokenB,
            singleAToken: matches.singleAToken,
            singleBToken: matches.singleBToken,
            ...
            approvedByA: matches.approvedByA,
            approvedByB: matches.approvedByB,
            emailRetriedAt: matches.emailRetriedAt,
            waSentAt: matches.waSentAt,
            notes: matches.notes,
            matchedAt: matches.matchedAt,
            contactRevealedAt: matches.contactRevealedAt,
            returnedToPoolAt: matches.returnedToPoolAt,
      ...
      .input(z.object({
       ...
       changes: z.object({
         ...
         partnerReligiosity: z.string().optional(),
          stepParentOpenness: z.string().optional(),

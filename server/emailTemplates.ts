...
export const WOMEN_MATCHMAKING_EMAIL_1: EmailTemplate = {
  ...
  htmlBody: baseTemplate(`
    ...
    <p>זמן ההמתנה משתנה מאדם לאדם. התאמה נשלחת רק כשנמצאת התאמה הדדית ורלוונטית, ואין התחייבות למספר התאמות או לתדירות קבועה.</p>
...
export function buildMatchProposalEmail(params: {
  ...
  const isBoostSender = isBoost && params.boostRole === "sender";
  ...
  const content = `
    ...
    <p style="color:#444; font-size:16px; line-height:1.8;">
      ${isBoost
        ? (isBoostSender
          ? `בקשת ה־Boost שלך נשלחה לשני הצדדים. היא נוצרה על בסיס אלגוריתם ההתאמה והנתונים שמילאו שני הצדדים. <strong>התשלום ושליחת ה־Boost אינם אישור להתאמה. גם האישור שלך עדיין נדרש במייל.</strong> ההצעה לא נבחרה או נבדקה אישית על ידי הילית.`
          : `נשלחה אליך התאמה במסגרת מסלול Boost. היא נוצרה על בסיס אלגוריתם ההתאמה והנתונים שמילאו שני הצדדים. <strong>ההתאמה ממתינה לאישור שלך במייל.</strong> ההצעה לא נבחרה או נבדקה אישית על ידי הילית.`)
    ...
    <p style="color:#444; font-size:15px; line-height:1.8; margin:20px 0;">
      ${isBoost ? "אם ההצעה מעניינת, אפשר ללחוץ על \"כן, מעניין אותי\". גם מי ששלח את ה־Boost נדרש לאשר בנפרד." : `אם ההצעה מעניינת ${isFemale ? "אותך" : "אותך"}, ${isFemale ? "לחצי" : "לחץ"} על "כן, מעניין אותי".`}
      אם שני הצדדים מאשרים, פרטי יצירת הקשר נשלחים לשניהם.
      <br><br>
    ...
    <p style="color:#aaa; font-size:12px; text-align:center; margin-top:16px;">
      ההצעה תקפה ל-48 שעות. פרטי יצירת הקשר נחשפים רק אחרי אישור הדדי.
    </p>
  ...
  return {
    subject: isBoost
      ? (isBoostSender
        ? `⚡ בקשת ה־Boost שלך נשלחה ומחכה לאישור · ${params.compatibilityScore}%`
        : `⚡ נשלחה אליך התאמת Boost לאישור · ${params.compatibilityScore}%`)
      : `💛 יש לך התאמה שמחכה לך! ${params.compatibilityScore}%`,
    htmlBody: baseTemplate(content, params.recipientEmail, params.singleId),
    textBody: `שלום ${params.firstName},\n\n${isBoost ? (isBoostSender ? "בקשת ה־Boost שלך נשלחה לשני הצדדים. התשלום והשליחה אינם אישור להתאמה, וגם האישור שלך עדיין נדרש במייל" : "נשלחה אליך התאמה במסגרת מסלול Boost והיא ממתינה לאישור שלך במייל") : "יש לך הצעת התאמה חדשה"}. ${isBoost ? "ההצעה נוצרה על ידי האלגוריתם ולא נבחרה או נבדקה אישית על ידי הילית." : ""}\n\nאחוז התאמה: ${params.compatibilityScore}%\nהתאמה: ${params.matchFirstName}, ${params.matchAge}, ${params.matchCity}\n\nלאישור: ${params.yesUrl}\nלדחייה: ${params.noUrl}\n\nצוות הילית כספי`,
  };
}
...
const WOMEN_MATCHMAKING_WELCOME_EMAIL_1: EmailTemplate = {
  ...
  htmlBody: baseTemplate(`
    ...
    <div style="background:#fff8dc; border:1px solid #ead47e; border-radius:14px; padding:20px 22px; margin:22px 0;">
      <h3 style="color:#191265; font-size:17px; margin:0 0 10px;">חשוב לי שנהיה מתואמות בציפיות</h3>
      <p style="color:#555; font-size:14px; line-height:1.8; margin:0;">דמי ההצטרפות הם עבור הכניסה למאגר ותהליך ההתאמה המקצועי. הם אינם שירות ליווי אישי ואינם התחייבות למספר התאמות או לתדירות קבועה. התאמה נשלחת רק כשנמצאת התאמה הדדית ורלוונטית — לא כדי לעמוד במכסת שליחות.</p>
    </div>
    <p>זמן ההמתנה משתנה מאדם לאדם ותלוי במאפיינים ובהעדפות של שני הצדדים. המטרה שלי היא להגדיל בהתמדה את מספר ההזדמנויות המתאימות, בלי להחליף איכות בכמות.</p>
    <hr class="divider" />
    ${emailSignature()}
  `),
  textBody: `{{firstName}}, ברוכה הבאה למאגר!\n\nאיך התהליך עובד:\n1. בדיקה אישית של הפרופיל\n2. הצעת התאמה לשני הצדדים\n3. רק אם שניכם אישרו - הפרטים ייחשפו\n4. הפגישה ביניכם\n\nחשוב לדעת: דמי ההצטרפות הם עבור הכניסה למאגר ותהליך ההתאמה המקצועי. אין התחייבות למספר התאמות או לתדירות קבועה. התאמה נשלחת רק כשנמצאת התאמה הדדית ורלוונטית. זמן ההמתנה משתנה מאדם לאדם.\n\nבאהבה,\nהילית כספי\nמאמנת ומשדכת | Relationship Expert & Matchmaker`,
};
...
const WOMEN_MATCHMAKING_WELCOME_EMAIL_3: EmailTemplate = {
  subject: "{{firstName}}, למה לא שולחים התאמה רק כדי לשלוח",
  htmlBody: baseTemplate(`
    <h2>{{firstName}}, חשוב לי להסביר מה קורה מאחורי הקלעים</h2>
    <p>לפעמים שואלים אותי למה לא נשלחת התאמה חדשה בכל כמה ימים. התשובה היא שהמאגר אינו אפליקציה שמציגה פרופילים לפי כמות. כל הצעה צריכה להתאים לשני אנשים במקביל: גיל, אזור, אורח חיים, רצון בילדים, ערכים, שאלון מדעי והעדפות הדדיות.</p>
    <div class="quote">המטרה אינה לשלוח יותר שמות. המטרה היא להגדיל את מספר ההזדמנויות שבאמת יש להן סיכוי להפוך לשיחה, לפגישה ולקשר.</div>
    <p>המאגר ממשיך לגדול, פרופילים חדשים נבדקים ונוספים, והמערכת בוחנת התאמות מחדש. כשנמצאת התאמה רלוונטית, תקבלי מייל ו־SMS.</p>
    <p>כדי שאוכל לדייק עוד יותר, חשוב לשמור את התמונה, ההעדפות והתיאור שלך מעודכנים:</p>
    <a href="${WHATSAPP_LINK}" class="cta">עדכון פרופיל בוואטסאפ ←</a>
    <hr class="divider" />
    ${emailSignature()}
  `),
  textBody: `{{firstName}}, חשוב לי להסביר מה קורה מאחורי הקלעים.\n\nהמאגר אינו אפליקציה שמציגה פרופילים לפי כמות. כל הצעה צריכה להתאים לשני הצדדים. אין התחייבות לתדירות קבועה; כשנמצאת התאמה רלוונטית תקבלי מייל ו-SMS.\n\nהמטרה אינה לשלוח יותר שמות, אלא להגדיל את מספר ההזדמנויות שבאמת יכולות להפוך לקשר.\n\nלעדכון פרופיל: ${WHATSAPP_LINK}\n\nבאהבה,\nהילית כספי`,
};

const WOMEN_MATCHMAKING_WELCOME_EMAIL_4: EmailTemplate = {
  subject: "{{firstName}}, רוצה תמיכה אישית מעבר למאגר?",
  htmlBody: baseTemplate(`
    <h2>{{firstName}}, רוצה תמיכה אישית מעבר למאגר?</h2>
    <p>המאגר הוא שירות התאמה, לא תהליך ליווי אישי. אם את רוצה לעבוד גם על דפוסים, בחירה נכונה, תקשורת והתנהלות בדייטים, אפשר לקבוע פגישה אישית עם הילית או עם אחת המלוות המקצועיות בצוות.</p>
    <p>בפגישה נבין מה נכון לך ונבדוק האם פגישה ממוקדת או תהליך ליווי מתאים לצורך שלך.</p>
    <a href="https://hilitcaspi.com/single-session" class="cta">לפרטים ולקביעת פגישה אישית ←</a>
    <hr class="divider" />
    ${emailSignature()}
  `),
  textBody: `{{firstName}}, רוצה תמיכה אישית מעבר למאגר?\n\nהמאגר הוא שירות התאמה, לא תהליך ליווי אישי. לפרטים ולקביעת פגישה אישית: https://hilitcaspi.com/single-session\n\nבאהבה,\nהילית כספי`,
};
...
const MEN_MATCHMAKING_WELCOME_EMAIL_1: EmailTemplate = {
  ...
  htmlBody: baseTemplate(`
    ...
    <div style="background:#fff8dc; border:1px solid #ead47e; border-radius:14px; padding:20px 22px; margin:22px 0;">
      <h3 style="color:#191265; font-size:17px; margin:0 0 10px;">חשוב לי שנהיה מתואמים בציפיות</h3>
      <p style="color:#555; font-size:14px; line-height:1.8; margin:0;">דמי ההצטרפות הם עבור הכניסה למאגר ותהליך ההתאמה המקצועי. הם אינם שירות ליווי אישי ואינם התחייבות למספר התאמות או לתדירות קבועה. התאמה נשלחת רק כשנמצאת התאמה הדדית ורלוונטית — לא כדי לעמוד במכסת שליחות.</p>
    </div>
    <p>זמן ההמתנה משתנה מאדם לאדם ותלוי במאפיינים ובהעדפות של שני הצדדים. המטרה שלי היא להגדיל בהתמדה את מספר ההזדמנויות המתאימות, בלי להחליף איכות בכמות.</p>
    <hr class="divider" />
...
const MEN_MATCHMAKING_WELCOME_EMAIL_3: EmailTemplate = {
  ...
  htmlBody: baseTemplate(`
    ...
    <p>לפעמים שואלים אותי למה לא נשלחת התאמה חדשה בכל כמה ימים. התשובה היא שהמאגר אינו אפליקציה שמציגה פרופילים לפי כמות. כל הצעה צריכה להתאים לשני אנשים במקביל: גיל, אזור, אורח חיים, רצון בילדים, ערכים, שאלון מדעי והעדפות הדדיות.</p>
    <div class="quote">המטרה אינה לשלוח יותר שמות. המטרה היא להגדיל את מספר ההזדמנויות שבאמת יש להן סיכוי להפוך לשיחה, לפגישה ולקשר.</div>
    <p>המאגר ממשיך לגדול, פרופילים חדשים נבדקים ונוספים, והמערכת בוחנת התאמות מחדש. כשנמצאת התאמה רלוונטית, תקבל מייל ו־SMS.</p>
    <p>כדי שאוכל לדייק עוד יותר, חשוב לשמור את התמונה, ההעדפות והתיאור שלך מעודכנים:</p>
    <a href="${WHATSAPP_LINK}" class="cta">עדכון פרופיל בוואטסאפ ←</a>
    <hr class="divider" />
    ${emailSignature()}
  `),
  textBody: `{{firstName}}, חשוב לי להסביר מה קורה מאחורי הקלעים.\n\nהמאגר אינו אפליקציה שמציגה פרופילים לפי כמות. כל הצעה צריכה להתאים לשני הצדדים. אין התחייבות לתדירות קבועה; כשנמצאת התאמה רלוונטית תקבל מייל ו-SMS.\n\nהמטרה אינה לשלוח יותר שמות, אלא להגדיל את מספר ההזדמנויות שבאמת יכולות להפוך לקשר.\n\nלעדכון פרופיל: ${WHATSAPP_LINK}\n\nהילית`,
};
...
const MEN_MATCHMAKING_WELCOME_EMAIL_4: EmailTemplate = {
  ...
  htmlBody: baseTemplate(`
    <h2>{{firstName}}, רוצה תמיכה אישית מעבר למאגר?</h2>
    <p>המאגר הוא שירות התאמה, לא תהליך ליווי אישי. אם אתה רוצה לעבוד גם על דפוסים, בחירה נכונה, תקשורת והתנהלות בדייטים, אפשר לקבוע פגישה אישית עם הילית או עם אחד המלווים המקצועיים בצוות.</p>
    <p>בפגישה נבין מה נכון לך ונבדוק האם פגישה ממוקדת או תהליך ליווי מתאים לצורך שלך.</p>
    <a href="https://hilitcaspi.com/single-session" class="cta">לפרטים ולקביעת פגישה אישית ←</a>
    <hr class="divider" />
    ${emailSignature()}
...
export function buildMatchFollowUpEmail(params: {
  ...
  const content = `
    <h2 style="color:#191265; font-size:22px; margin-bottom:8px;">${isBoost ? "התאמת ה־Boost עדיין ממתינה לאישור שלך" : "שבוע עבר"}, ${params.firstName} 💛</h2>
    <p style="color:#444; font-size:16px; line-height:1.8;">
      ${isBoost ? "לפני כמה ימים נשלחה אליך במסגרת מסלול Boost התאמה עם" : "לפני שבוע שלחתי לך הצעה:"} ${params.matchFirstName}, ${params.matchAge}, ${params.matchCity}.
    </p>
    <p style="color:#444; font-size:16px; line-height:1.8;">
    ...
    <div style="background:#f9f6f0; border-radius:14px; padding:24px 28px; margin:28px 0;">
      ...
      <p style="font-size:15px; color:#444; line-height:1.8; margin:0 0 16px;">
        ...
        התשובה שלך עוזרת לשפר את ההתאמות שיוצגו לך בעתיד.
      </p>
    ...
    <p style="color:#aaa; font-size:13px; text-align:center; margin-top:8px;">
      פרטי יצירת הקשר נחשפים רק אחרי אישור הדדי. אין מחויבות.
    </p>
    ${emailSignature()}
  `;
  return {
    subject: `${params.firstName}, ${isBoost ? "התאמת ה־Boost" : "ההצעה"} עדיין ממתינה לך 💛`,
    htmlBody: baseTemplate(content, params.recipientEmail, params.singleId),
    textBody: `שלום ${params.firstName},\n\n${isBoost ? "נשלחה אליך במסגרת מסלול Boost התאמה עם" : "לפני שבוע נשלחה אליך הצעה:"} ${params.matchFirstName}, ${params.matchAge}, ${params.matchCity}.\n\nהכפתורים עדיין פעילים:\nכן: ${params.yesUrl}\nלא: ${params.noUrl}\n\nצוות הילית כספי`,
  };
}

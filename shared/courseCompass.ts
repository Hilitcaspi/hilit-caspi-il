export const COURSE_COMPASS_VERSION = "2026-09-v5";
...
function resultContent(key: CoreCompassResultKey, gender: CompassGender): CompassResultContent {
  ...
  const content: Record<CoreCompassResultKey, CompassResultContent> = {
    future_projection: {
      ...
      recommendationTitle: female ? "אל תנסי עדיין להשיג אותו. בדקי קודם אם יש כאן קשר אמיתי להשיג." : "אל תנסה עדיין להשיג אותה. בדוק קודם אם יש כאן קשר אמיתי להשיג.",
      recommendationBody: female ? "אני לא ממליצה להוציא אותו מיד, אבל גם לא להמשיך לבנות בראש את מה שעוד לא קרה. המשיכי רק אם יש ממנו יוזמה, עקביות והתקדמות שאפשר לראות במציאות." : "אני לא ממליצה להוציא אותה מיד, אבל גם לא להמשיך לבנות בראש את מה שעוד לא קרה. המשך רק אם יש ממנה יוזמה, עקביות והתקדמות שאפשר לראות במציאות.",
      next72Hours: female ? "בשלושת הימים הקרובים אל תוסיפי משמעות לשום רמז. כתבי לעצמך רק שלוש עובדות: מה הוא יזם, מה הוא קיים ולאן הקשר התקדם." : "בשלושת הימים הקרובים אל תוסיף משמעות לשום רמז. כתוב לעצמך רק שלוש עובדות: מה היא יזמה, מה היא קיימה ולאן הקשר התקדם.",
    ...
    uncertainty_loop: {
      ...
      recommendationTitle: female ? "אל תנסי לגרום לו לרצות אותך יותר. בקשי בהירות פעם אחת." : "אל תנסה לגרום לה לרצות אותך יותר. בקש בהירות פעם אחת.",
      recommendationBody: female ? "אם הוא עונה בצורה ברורה וגם מתנהג בהתאם, יש טעם להמשיך לבדוק את הקשר. אם הוא משאיר אותך שוב בערפל, ההמלצה שלי היא להפסיק לרדוף ולא לתת לחוסר הוודאות להתחפש לאהבה." : "אם היא עונה בצורה ברורה וגם מתנהגת בהתאם, יש טעם להמשיך לבדוק את הקשר. אם היא משאירה אותך שוב בערפל, ההמלצה שלי היא להפסיק לרדוף ולא לתת לחוסר הוודאות להתחפש לאהבה.",
      next72Hours: female ? "שלחי הודעה אחת ברורה שמזמינה פעולה ממשית. אחר כך אל תנתחי מילים. בדקי אם הוא קובע, מגיע וממשיך." : "שלח הודעה אחת ברורה שמזמינה פעולה ממשית. אחר כך אל תנתח מילים. בדוק אם היא קובעת, מגיעה וממשיכה.",
    ...
    approval_chase: {
      ...
      recommendationTitle: female ? "עצרי את המשימה להשיג אותו. עכשיו בדקי אם את בכלל בוחרת בו." : "עצור את המשימה להשיג אותה. עכשיו בדוק אם אתה בכלל בוחר בה.",
      recommendationBody: female ? "אם היחס שאת מקבלת אינו היחס שאת רוצה בתוך זוגיות, הבחירה שלו לא תהפוך אותו למתאים. אני ממליצה להמשיך רק אם אפשר לראות הדדיות, כבוד ומאמץ משני הצדדים." : "אם היחס שאתה מקבל אינו היחס שאתה רוצה בתוך זוגיות, הבחירה שלה לא תהפוך אותה למתאימה. אני ממליצה להמשיך רק אם אפשר לראות הדדיות, כבוד ומאמץ משני הצדדים.",
      next72Hours: female ? "כתבי שלושה דברים שאת צריכה בקשר והשווי אותם למה שקורה בפועל. אל תתני לצורך להיבחר למחוק את הרשימה." : "כתוב שלושה דברים שאתה צריך בקשר והשווה אותם למה שקורה בפועל. אל תיתן לצורך להיבחר למחוק את הרשימה.",
    ...
    chemistry_confusion: {
      ...
      recommendationTitle: female ? "אל תוציאי אותו רק בגלל העוצמה. אבל אל תבחרי בו רק בגללה." : "אל תוציא אותה רק בגלל העוצמה. אבל אל תבחר בה רק בגללה.",
      recommendationBody: female ? "אני ממליצה לתת לקשר עוד מרחב קצר וברור ולבדוק ארבעה דברים: זמינות, עקביות, יחס וערכים. אם הכימיה חזקה אבל אלה חסרים, היא אינה סיבה להישאר." : "אני ממליצה לתת לקשר עוד מרחב קצר וברור ולבדוק ארבעה דברים: זמינות, עקביות, יחס וערכים. אם הכימיה חזקה אבל אלה חסרים, היא אינה סיבה להישאר.",
      next72Hours: female ? "במפגש או בשיחה הבאה אל תמדדי רק כמה התרגשת. בדקי אם הרגשת בטוחה, נראית, מכובדת ורגועה מספיק להיות עצמך." : "במפגש או בשיחה הבאה אל תמדוד רק כמה התרגשת. בדוק אם הרגשת בטוח, נראה, מכובד ורגוע מספיק להיות עצמך.",
    ...
    novelty_pull: {
      ...
      recommendationTitle: female ? "אל תרדפי אחריו עכשיו. תני לו הזדמנות להתקרב אלייך." : "אל תרדוף אחריה עכשיו. תן לה הזדמנות להתקרב אליך.",
      recommendationBody: female ? "אם כל העניין נעלם ברגע שהוא זמין, ייתכן שהמרדף הוא מה שמושך אותך. אם הוא נשאר רחוק ולא עושה צעד ממשי, אני ממליצה להפסיק לנסות להשיג אותו." : "אם כל העניין נעלם ברגע שהיא זמינה, ייתכן שהמרדף הוא מה שמושך אותך. אם היא נשארת רחוקה ולא עושה צעד ממשי, אני ממליצה להפסיק לנסות להשיג אותה.",
      next72Hours: female ? "אל תיזמי עוד מהלך כדי להחזיר את המתח. השאירי מקום ובדקי אם הוא בוחר להתקרב בלי שתנהלי את המרדף." : "אל תיזום עוד מהלך כדי להחזיר את המתח. השאר מקום ובדוק אם היא בוחרת להתקרב בלי שתנהל את המרדף.",
...
export function getCompassResultContent(key: CompassResultKey, gender: CompassGender = "female") {
  if (key === "safety") {
    return {
      ...
      recommendationTitle: "לא ממשיכים לנסות להשיג אדם כשאין תחושת ביטחון.",
      recommendationBody: "ההמלצה היא להתרחק מהלחץ ולפנות לאדם בטוח או לעזרה מקצועית מתאימה.",
      next72Hours: "צרו קשר עם אדם בטוח ואל תישארו לבד עם תחושת איום או לחץ.",

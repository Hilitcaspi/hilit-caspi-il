...
const faqs = [
  ...
  { q: "האם זו התחייבות או מנוי?", a: "לא. התשלום הוא חד־פעמי בסך 399 ₪. אין חיוב מתחדש, ו־Plus אינו מופעל אוטומטית." },
  { q: "כבר הצטרפתי למאגר. האם הבאנדל מתאים לי?", a: "אין צורך לשלם שוב על רכיב שכבר נרכש. אפשר לרכוש את המדריך או את הקורס בנפרד. Boost ו־Plus הם שירותים נפרדים." },
    ...
    <div className={`relative overflow-hidden rounded-[1.75rem] border border-[#f5d27f]/35 bg-[#240e2d]/72 shadow-[0_28px_70px_rgba(26,5,24,0.38)] backdrop-blur-xl ${condensed ? "p-5" : "p-6 md:p-7"}`}>
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <span className="rounded-full bg-[#e14f75] px-3 py-1.5 text-xs font-black text-white shadow-lg shadow-[#e14f75]/25">חיסכון של 298 ₪</span>
        ...
        <div className="mt-5 grid grid-cols-3 gap-2 text-center md:gap-3">
          ...
          <div className="rounded-2xl bg-[linear-gradient(135deg,#fff0bd_0%,#f5c76a_55%,#dfa451_100%)] px-1 py-3 text-[#351330] shadow-[0_12px_28px_rgba(245,199,106,0.28)]"><div className="text-[10px] font-black">מחיר החג</div><div className="mt-1 text-2xl font-black md:text-3xl">399 ₪</div></div>
        </div>
...
export default function NewYearLoveBundle() {
  ...
  useEffect(() => {
    ...
    const description = "חבילת חגי תשרי של הילית כספי: מאגר הרווקים והרווקות, המדריך לבחור נכון והקורס המסע ב־399 ₪ בתשלום חד־פעמי.";

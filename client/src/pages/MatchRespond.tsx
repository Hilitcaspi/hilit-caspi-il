      ...
      <div className="bg-white rounded-3xl shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="text-[#727272] text-sm text-center mb-5 leading-relaxed">
            {isBoost ? "התשלום ושליחת ה־Boost אינם אישור להתאמה. כל אחד מהצדדים נדרש לאשר בנפרד, ורק לאחר שני אישורים יישלחו פרטי יצירת הקשר." : "אם שניכם תאמרו כן, אשלח לשניכם את פרטי הקשר המלאים."}
            <br />

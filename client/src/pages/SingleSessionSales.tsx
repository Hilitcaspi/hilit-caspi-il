        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="text-right order-2 md:order-1">
            ...
            <p className="text-white/50 text-sm mb-4 leading-relaxed">
              הפגישה תתקיים עם הילית או עם אחד המלווים המקצועיים בצוות, שעברו הכשרה מלאה ועובדים בליווי צמוד שלה.
            </p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
             {[
                ...
                { q: "עם מי הפגישה?", a: "הפגישה תתקיים עם הילית או עם אחד המלווים המקצועיים בצוות שלה. כל המלווים עברו הכשרה מלאה ועובדים בליווי צמוד של הילית, שמתבוננת על כל תהליך ומלווה מלמעלה." },
                { q: "מה קורה אחרי הפגישה?", a: "הפגישה נותנת לנו תמונה ברורה עלייך, מה שעוזר לנו להתאים לך בצורה טובה יותר אם תחליט/י להצטרף למאגר הרווקים או להמשיך לתהליך ליווי. אם תמשיך/י לתהליך מלא, ה-₪500 יקוזזו מהמחיר." },

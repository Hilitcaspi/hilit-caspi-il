      ...
      <section className="bg-[#191265] py-20 px-6">
        <AnimatedSection>
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.p variants={fadeUp} className="text-white/60 text-lg mb-6 max-w-2xl mx-auto">
              אני מאמינה שאהבה אמיתית היא גם מדע וגם קסם. אחרי שנים של מחקר, ליווי של מאות אנשים, ולימוד עמוק של פסיכולוגיה זוגית, פיתחתי שיטה שמשלבת את שניהם.
            </motion.p>
            <motion.p variants={fadeUp} className="text-white/80 text-base mb-14 max-w-2xl mx-auto leading-relaxed">
              השיטה שלי מבוססת על מחקרים מעולם הפסיכולוגיה, תורת ההתקשרות, ומודלים מוכחים לחיזוי הצלחה זוגית. מתוך השיטה הזו נולדו כל המוצרים שלי: שאלון ה-DNA הזוגי שמגלה את הדפוס הפנימי שלך, המדריך שנותן כלים מעשיים לבחירה נכונה, הקורס שמלווה אותך בתהליך שלם, והמאגר שמחבר בין אנשים על בסיס התאמה עמוקה ולא רק מראה חיצוני.
            </motion.p>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  num: "01",
                  title: "הבנת הדפוס הפנימי",
                  text: "לכל אחד מאיתנו יש DNA זוגי. דפוס פנימי שמושך אותנו לטיפוסים מסוימים. כשמבינים את הדפוס, מפסיקים לחזור על אותן טעויות ומתחילים לבחור אחרת.",
                  color: "#ffe27c",
                },
                {
                  num: "02",
                  title: "כלים מדעיים לבחירה נכונה",
                  text: "אני מלמדת איך לזהות את האדם הנכון, איך להפסיק לתת לפחדים לשלוט, ואיך להיכנס לאהבה מתוך בחירה. כל זה בעזרת מודלים פסיכולוגיים שנותנים שפה למה שקורה בפנים.",
                  color: "#1800ad",
                },
                {
                  num: "03",
                  title: "התאמה שמבוססת על עומק",
                  text: "כל התאמה שאני עושה בנויה על הבנה עמוקה של שני הצדדים. לא רק מה הם רוצים, אלא מה יגרום להם להרגיש שהם בית אצל האחר. מדע + אינטואיציה = קסם.",
                  color: "#ffe27c",
                },

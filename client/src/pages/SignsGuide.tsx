          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeUp} className="text-right">
              ...
              <p className="text-[#555] leading-relaxed mb-4">
                Relationship Expert ושדכנית מקצועית. מאחוריי שעות רבות של ליווי אינטנסיבי של רווקים ורווקות לזוגיות, פודקאסט פעיל ומאגר שידוכים המבוסס על שאלוני עומק ובדיקה מקצועית.
              </p>
              <p className="text-[#555] leading-relaxed mb-4">

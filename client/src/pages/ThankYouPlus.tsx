  ...
  return (
    <main className="min-h-screen bg-[#f0eadc] px-5 py-16 font-rubik text-[#191265]" dir="rtl">
      <section className="mx-auto max-w-xl rounded-[30px] bg-white p-8 text-center shadow-xl">
        ...
        <p className="mt-3 text-sm leading-7 text-[#666]">לאחר ש־Grow יאשר את העסקה, המנוי יופעל ויישלח אלייך מייל עם קישור לאזור האישי. שם יוצגו מחזור החיוב, מונה ההצעות ותאריך החיוב הבא.</p>
        ...
        <Link href={profileUrl}><span className="mt-6 block cursor-pointer rounded-2xl bg-[#191265] py-4 font-black text-white">{email && token ? "לאזור האישי" : "חזרה לאתר"}</span></Link>
